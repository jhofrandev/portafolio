...
export default function ModalSkills() {
  ...
  return (
    <div
      ...
      className={`${
        state.isOpenModalSkills ? "flex flex-col gap-0.5" : "hidden"
    ...
    >
      ...
      >
        ...
        <button
          ...
          onClick={() => dispatch({ type: "is-open-modal-skills" })}
        >
          X
        </button>
      </div>
      <article className="px-4 pt-4">
        <div className="flex gap-2 py-3 border-y border-dashed border-[#B9B28A] font-[VT323] text-xl">
          <svg
            className="h-7 w-7"
        ...
        <div className="flex gap-2 py-3 border-y border-dashed border-[#B9B28A] font-[VT323] text-xl">
          ...
          <h2>Node.js, TypeScripts, React.js</h2>
        </div>
        <div className="flex gap-2 py-3 border-y border-dashed border-[#B9B28A] font-[VT323] text-xl">
          <svg
            className="h-7 w-7"
